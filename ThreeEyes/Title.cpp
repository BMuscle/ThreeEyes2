...
static Sprite Title;					//タイトル用のハンドル
...
void Title_Initialize() {
	...
	Title = initSprite("images/title.png", 720, 405);
	...
	endButton[1] = initSprite("images/button/Title_end2.png", BUTTON_W, BUTTON_H);
...
void Title_Draw() {
	...
	drawAtSprite(WINDOW_WIDTH/2, 100, &Title, TRUE);		
